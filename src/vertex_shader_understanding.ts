...
// -------------- Let's explore VERTEX SHADER to understand it -----------------
// I left a lot of comments in    src/shaders/test/vertex.glsl
// where we were dealing with vertex shader for this lesson

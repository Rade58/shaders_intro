...
import vertexShader from "./shaders/color_variations/vertex.glsl";
import fragmentShader from "./shaders/color_variations/fragment.glsl";

// -------------- Color variations -----------------

// WE wiil do something more to our previous example
// We will add brightness variations as if there are shadows
// so we will like mimic shadows

// we will add more brightness when vertices are high on z axes
// and less brightness in oposite direction over z

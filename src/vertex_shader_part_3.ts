...
import vertexShader from "./shaders/test3/vertex.glsl";
import fragmentShader from "./shaders/test3/fragment.glsl";

// -------------- Understanding vertex shader, part three -----------------
// look for comments in:
//                        src/shaders/test3/vertex.glsl
//
// ------------------------------------
// ------------ gui -------------------

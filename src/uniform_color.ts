...
import vertexShader from "./shaders/uniform_color/vertex.glsl";
import fragmentShader from "./shaders/uniform_color/fragment.glsl";

// -------------- Understanding Uniforms part five-----------------

// We are going to pass Color instance as a uniform
// Color instance also inherits from Vector3 so when it
// gets inside shader it will be vec3 instance

// we can use that vec3 to define color inside
// fragment shader
